...
void displayLoraTx1(int number, String battery) {
  currentBackground = ST77XX_WHITE;
  tft.fillScreen(currentBackground);
  String msg = "Sent msg #" + String(number);
  String batt = "Battery: "+ battery +"%";
